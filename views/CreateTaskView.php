...
<head>
    ...
    <title>AGENDALY - Create tash</title>
...
<body>
    <div class="card">
        ...
        <h2 class="title">Créez votre tâche</h2>

        <form action='/createTask?filterExist=<?=$filter_exist?>&filter=<?=($filter)?>&filterEvent=<?=($filter_event)?>&page=<?=$current_page?>' method='POST'>
          ...
          <input type="submit" name="submitTask" class="btn-save submit-event" value="Enregistrer">
